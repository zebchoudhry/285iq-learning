"""
Decision Engine v1.0 - Django Adapter (FIXED)
...
from learning.models import QuizAttempt, Topic, StudySession
...
def evaluate_student_subject(
    ...
    attainment = calculate_attainment_band(weekly, coverage_breadth=coverage, min_weeks=1)  # FIXED: Allow 1 week
